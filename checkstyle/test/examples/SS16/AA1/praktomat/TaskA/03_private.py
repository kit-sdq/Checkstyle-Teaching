...
tests = [
         ...
         {
         'name'        : 'Start - incorrect argument order',
         'description' : 'Tests if an error-message is printed in case that the order of the provided arguments is invalid.',
         'protocol'    : '01_start_01_incorrectargsorder.txt',
         },
         {
...
for test in tests:
    ...
    test['protocol'] = 'copy/protocols/03_error/' + test.get('protocol')
