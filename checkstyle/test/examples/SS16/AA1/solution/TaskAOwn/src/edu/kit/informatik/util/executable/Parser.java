...
public final class Parser {
    ...
    private final edu.kit.informatik._intern.util.collections.Cache<String, SymbolMap> cache;
    ...
    private Parser(final Map<Symbol<?>, String> symbols, final Pattern pattern) {
        ...
        cache = new edu.kit.informatik._intern.util.collections.Cache<>();
    }
    ...
    private Optional<SymbolMap> toSymbolMap(final String s, final Consumer<? super Throwable> exceptionHandler) {
        ...
        if (m.matches()) {
            ...
            for (final Map.Entry<Symbol<?>, String> entry : symbols.entrySet()) {
                ...
                try {
                    parsed.put(symbol, edu.kit.informatik._intern.util.invoke.Invocations.convert(symbol.clazz(), val));
                } catch (final edu.kit.informatik._intern.util.invoke.InvocationException e) {
    ...
    public static final class Builder {
        ...
        private void add(final Lookup lookup, final Field field, final ClassLoader loader) {
            synchronized (field) {
                ...
                final Symbol<?> current = (Symbol<?>) edu.kit.informatik._intern.util.invoke.Invocations.invoke(getter);
                ...
                if (current != null) {
                    ...
                    edu.kit.informatik._intern.util.invoke.Invocations.invoke(setter, symbol);
                }
            }
        }
    }
    ...
    public static final class Symbol<T> {
        ...
        /**
         * Returns the class of the type-parameter of this symbol.
         * 
