...
public final class ObjectUtil {
     ...
     */
    @SafeVarargs
    public static <R> R coalesce(final Supplier<? extends R>... suppliers) {
     ...
     * @return the first non-{@code null} value
     */
    public static <R> R coalesce(final Supplier<? extends R> a, final Supplier<? extends R> b) {
        requireNonNull(a, b);
     ...
     */
    public static <R> R coalesce(final Supplier<? extends R> a, final Supplier<? extends R> b,
            final Supplier<? extends R> c, final Supplier<? extends R> d) {
     ...
     */
    public static <R> R coalesce(final Supplier<? extends R> a, final Supplier<? extends R> b,
            final Supplier<? extends R> c, final Supplier<? extends R> d, final Supplier<? extends R> e) {
     ...
     */
    @SafeVarargs
    public static <T> void requireNonNull(final T... references) {
