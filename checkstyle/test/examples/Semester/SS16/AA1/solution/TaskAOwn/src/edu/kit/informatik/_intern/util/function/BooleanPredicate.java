...
/**
 * Represents a predicate (boolean-valued function) of one {@code boolean}-valued argument. This is the {@code
 * boolean}-consuming primitive type specialization of {@link Predicate}.
 * 
 * <p>This is a {@linkplain FunctionalInterface functional interface} whose functional method is {@link #test(boolean)}.
 * 
