...
public final class Token<T extends ModuleInformation> {
    ...
    /**
     * Returns the content of the {@code n'th} capture group of the pattern that can be obtained by calling the {@link
     * ModuleInformation#format()} method on the object returned by the {@link #module()} method.
     * 
