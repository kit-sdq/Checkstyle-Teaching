...
tests = [
    ...
    {
        'name': 'turn left test',
        'description': 'Tests if the turn-left command works correctly.',
        'protocol': 'turnleft.txt',
    },
    {
        'name': 'turn right test',
        'description': 'Tests if the turn-right command works correctly.',
        'protocol': 'turnright.txt',
    },
    {
        'name': 'token test',
