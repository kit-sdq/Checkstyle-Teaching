...
tests = [
    ...
    {
        'name': 'illegal turn',
        'description': 'Tests if illegal turns are handled correctly.',
        'protocol': 'turnillegal.txt',
    },
    {
        'name': 'turn after draw',
        'description': 'Tests if illegal turns after a draw are handled correctly.',
        'protocol': 'turndraw.txt',
    },
]
