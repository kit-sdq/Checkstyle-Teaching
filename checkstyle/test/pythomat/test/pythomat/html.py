...
class _Tag(object):
    ...
    def open(self):
        ...
        self.document.stream.write("<" + self.name + "".join([" " + str(key) + '="' + str(value) + '"' for key, value in list(self.attributes.items())]) + ">")
...
class Document(object):
    ...
    def cdata(self, string):
        ...
        """
        if not isinstance(string, str) and not isinstance(string, str):
